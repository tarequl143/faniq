    ...
    <div className="py-[100px] bg-hero_pattern bg-center bg-no-repeat bg-cover">
      <SectionWrapper>
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="w-40 h-12 p-4 z-10 bg-[#0DA6E9] relative overflow-hidden before:-z-10 before:content-[''] before:absolute before:bg-[#37BDF8] before:right-[110%] before:-top-[44px] before:w-[200%] before:h-[200%] before:rotate-[15deg] before:transition-all before:duration-500 hover:before:right-[-10%] rounded-md justify-center items-center gap-2.5 inline-flex mt-6">
